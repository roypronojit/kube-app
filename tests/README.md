...
| Module | Coverage |
| --- | --- |
| `manifest_tests/test_chart.py` | Basic end-to-end rendering and semantic equivalence, inline ConfigMaps and environment consumption, optional Service/ports, and service account creation (requires Helm) |
